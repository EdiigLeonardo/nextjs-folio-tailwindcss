...
const Navbar = () => {
  ...
  return (
    ...
    >
      ...
      <div
        className={
          nav ? 'md:hidden fixed left-0 bottom-0 top-0 right-0 w-full h-screen bg-black/70' : ''
        }
      >
        {/* Side Drawer Menu */}
        <div
          className={
            nav
              ? ' fixed left-0 top-0 bottom-0 w-[75%] sm:w-[60%] md:w-[45%] h-full bg-[#ecf0f3] p-10 ease-in duration-500'
